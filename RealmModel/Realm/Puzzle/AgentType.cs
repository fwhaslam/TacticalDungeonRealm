...
//======================================================================================================================
		...
		/// <summary>
		/// How much damage is generated by an attack ?
		/// </summary>
		/// <param name="target"></param>
		/// <param name="adds">Additional (positive) or reduced (negative) damage.</param>
		/// <returns>damage inflicted or zero.</returns>
		public int DamageTo( AgentType target, int adds ) {

			int total = Damage - target.Armor + adds;
